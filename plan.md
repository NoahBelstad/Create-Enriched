...
- THE CONTENTS BELOW MAY CONTAIN IMPLEMENTATION ERRORS, OVERLY SPECIFIC 
  MATH FORMULAS, OR UNBALANCED FEATURE DESCRIPTIONS.
- USE THIS ONLY AS A GENERAL GUIDEPOST FOR SPRINT GOALS AND CORE CONCEPTS.
- DO NOT TREAT ANY API SPEC, BLOCK RATIO, OR EXACT NUMERICAL VALUES IN THIS 
  FILE AS FINAL ARCHITECTURE UNTIL VERIFIED IN CODE.
================================================================================
-->
