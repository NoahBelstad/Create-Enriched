> **NOTE TO FUTURE SELF / INTERNAL REFERENCE ONLY**
>
> THIS IS AN AI-GENERATED SUMMARY CREATED FOR QUICK BRAINSTORMING AND TASK TRACKING.
> - THIS FILE DOES NOT ACT AS A MOD README OR PUBLIC SPECIFICATION.
> - THE CONTENTS BELOW MAY CONTAIN IMPLEMENTATION ERRORS, OVERLY SPECIFIC MATH FORMULAS, OR UNBALANCED FEATURE DESCRIPTIONS.
> - USE THIS ONLY AS A GENERAL GUIDEPOST FOR SPRINT GOALS AND CORE CONCEPTS.
> - DO NOT TREAT ANY API SPEC, BLOCK RATIO, OR EXACT NUMERICAL VALUES IN THIS FILE AS FINAL ARCHITECTURE UNTIL VERIFIED IN CODE.
...
* **Refining Loop:**
  1. **Ore Washing:** Mechanical Belt washing to clean raw ore.
  2. **Acid Dissolution:** Basin mixing with concentrated acid to produce Uranyl Nitrate.
  3. **Centrifuge Separation:** Liquid processed in a kinetic `CentrifugeBlockEntity` within a strict speed range (192 RPM to 256 RPM) to isolate U-235 from U-238 slurry.
  4. **Pellet Compacting:** Mechanical Pressing of U-235 in basin molds to form Fuel Pellets.
